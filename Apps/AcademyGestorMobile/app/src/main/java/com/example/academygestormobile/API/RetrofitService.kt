...
interface RetrofitService {
    ...
    @GET("profesores/email/{email}")
    suspend fun getProfesorByEmail(
    ...
    @DELETE("faltas_asistencia/eliminar/{id}")
    suspend fun deleteFalta(@Path("id") id: Int): Boolean
...
object RetrofitServiceFactory {
    ...
    fun makeRetrofitService(): RetrofitService {
        return Retrofit.Builder()
            .baseUrl("http://192.168.1.137:8080/escuela_circo/")

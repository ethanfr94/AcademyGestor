...
CREATE TABLE `actividades` (
  ...
  `titulo` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `tipo` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `descripcion` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `fini` date NOT NULL,
  `ffin` date NOT NULL,
  `hini` time NOT NULL,
  `hfin` time NOT NULL,
  ...
  `coment_transporte` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `alojamiento_req` bit(1) NOT NULL,
  `coment_alojamiento` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `comentarios` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `estado` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `coment_estado` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `incidencias` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `url_folleto` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  ...
  `longitud` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `latitud` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `contratos` (
  ...
  `url_presupuesto` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  `url_factura` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cursos` (
  ...
  `cod_curso` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `titulo` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `etapa` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `emp_transporte` (
  ...
  `direccion` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  ...
  `contacto` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `fotos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `url_foto` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
INSERT INTO `fotos` VALUES (23,'temp_image_1738232361314.jpg','Foto de la actividad 18',18),(24,'temp_image_1738232361248.jpg','Foto de la actividad 18',18),(25,'temp_image_1738233067460.jpg','Foto de la actividad 18',18),(26,'temp_image_1738233117119.jpg','Foto de la actividad 18',18),(27,'temp_image_1738233194307.jpg','Foto de la actividad 18',18),(28,'temp_image_1738233482887.jpg','Foto de la actividad 18',18),(29,'temp_image_1738233500290.jpg','Foto de la actividad 18',18),(30,'temp_image_1738233500351.jpg','Foto de la actividad 18',18),(31,'temp_image_1738233583391.jpg','Foto de la actividad 18',18),(32,'temp_image_1738236163478.jpg','Foto de la actividad 23',23),(33,'temp_image_1738236230317.jpg','Foto de la actividad 18',18),(34,'temp_image_1738236249134.jpg','Foto de la actividad 12',12),(35,'temp_image_1738236263145.jpg','Foto de la actividad 23',23),(36,'temp_image_1738236263258.jpg','Foto de la actividad 23',23);
...
CREATE TABLE `grupos` (
  ...
  `cod_grupo` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `grupos_participantes` (
  ...
  `comentario` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profesores` (
  ...
  `correo` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `password` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `rol` enum('ADM','ED','PROF') CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL DEFAULT 'PROF',
  `activo` bit(1) NOT NULL DEFAULT b'1',
  `url_foto` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci,
...
INSERT INTO `puntos_interes` VALUES (32,18,'descripcion','-4.061645977199078','43.35328839881347');
...
-- Dump completed on 2025-05-28 18:32:09
